...
namespace DemoHangFire.Supervisao_v2
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseHangfireDashboard("/supervisao_v2");

            string nomeServico = "Job_1";
            RecurringJob.AddOrUpdate("supervisao_v2 - " + nomeServico, () => Console.WriteLine(nomeServico), Cron.Minutely());

            nomeServico = "Job_2";
            RecurringJob.AddOrUpdate("supervisao_v2 - " + nomeServico, () => Console.WriteLine(nomeServico), Cron.Hourly(5));
        }
